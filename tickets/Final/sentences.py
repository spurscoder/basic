...
sent_topic = {
    ...
    'search': ['为您查询到以下结果.', '查询结果如下.', '为您查到这些机票.', '有以下机票供您选择.', '已经为您查到这些机票信息.',
               '已经有了这些信息.', '有如下机票信息.', '您有以下几种票可选.']}
...
sent_multiAsk = {
    ...
    'dCity': ['我需要您的目的地.', '您的目的地是哪里.', '您的目的地是哪里.', '请告诉我您机票的目的地.', '我没有听到更多有用的信息.']}
...
dict_type_to_code = {'B737': '波音737(中)', '737': '波音737(中)', 'K320': '空客320(中)', 'M82': '麦道82(中)', 'M90': '麦道90(中)', 'B747': '波音747(宽)',
                     ...
                     'K330': '空客330(宽)', 'K340': '空客340(宽)', 'B738': '波音738(中)', '738': '波音738(中)', 'K321':'空客321(中)'}
dict_city_to_code = {'北京':['PEK', 'NAY'], '上海':['PVG', 'SHA'], '广州':['CAN'], '安庆':['AQG'],'蚌埠':['BFU'],'阜阳':['FUG'],'合肥':['HFE'],
                     '黄山':['TXN'],'南苑':['NAY'],'首都':['PEK'],'福州':['FOC'],'晋江':['JJN'],'连城':['LCX'],
                     ...
                     '安康':['AKA'],'延安':['ENY'],'汉中':['HZG'],'榆林':['UYN'],'西安':['XIY'],'浦东':['PVG'],'虹桥':['SHA'],
                     ...
                     '杭州':['HGH'],'舟山':['HSN'],'台州':['HYN'],'衢州':['JUZ'],'宁波':['NGB'],'温州':['WNZ'],'义乌':['YIW'],'重庆':['CKG','WXN'],
                     '香港':['HKG'],'澳门':['MFM']}
dict_plane_to_code = {'虹桥机场':['SHA'], '浦东机场':['PVG'], '首都机场':['PEK'], '天柱山机场': ['AQG'],
                      ...
                      '虹桥': ['SHA'], '浦东': ['PVG'], '首都': ['PEK'], '天柱山': ['AQG'],
                      '蚌埠': ['BFU'], '西关': ['FUG'], '骆岗': ['HFE'], '屯溪': ['TXN'], '南苑': ['NAY'], '首都国际': ['PEK'],
                      '长乐国际': ['FOC'], '长乐': ['FOC'], '晋江': ['JJN'], '连城': ['LCX'], '武夷山': ['WUS'],
                      '高崎国际': ['XMN'], '高崎': ['XMN'], '酒泉': ['CHW'], '敦煌': ['DNH'], '西峰镇': ['IQN'], '嘉峪关': ['JGN'],
                      '中川': ['LHW'], '白云国际': ['CAN'], '白云': ['CAN'], '沙堤': ['FUO'], '梅县': ['MXZ'], '外砂': ['SWA'],
                      '宝安国际': ['SZX'], '宝安': ['SZX'], '湛江': ['ZHA'], '三灶': ['ZUH'], '福城': ['BHY'], '两江国际': ['KWL'],
                      '两江': ['KWL'], '白莲': ['LZH'], '吴墟': ['NNG'], '长州岛': ['WUZ'], '兴义': ['ACX'], '田阳': ['AEB'],
                      '龙洞堡': ['KWE'], '大兴': ['TEN'], '遵义': ['ZYI'], '黎平': ['HZH'], '黄果树': ['AVA'], '美兰国际': ['HAK'],
                      '凤凰国际': ['SYX'], '邯郸': ['HDG'], '山海关': ['SHP'], '正定': ['SJW'], '安阳': ['AYN'], '新郑国际': ['CGO'],
                      '北郊': ['LYA'], '姜营': ['NNY'], '萨尔图': ['DQA'], '黑河': ['HEK'], '太平国际': ['HRB'], '东郊': ['JMU'],
                      '海浪': ['MDG'], '三家子': ['NDG'], '许家坪': ['ENH'], '天河国际': ['WUH'], '刘集': ['XFN'], '三峡': ['YIH'],
                      '沙市': ['SHS'], '桃花': ['CGD'], '黄花国际': ['CSX'], '荷花': ['DYG'], '芷江': ['HJJ'], '零陵': ['LLF'],
                      '龙嘉国际': ['CGQ'], '二台子': ['JIL'], '通化': ['TNH'], '朝阳川': ['YNJ'], '奔牛': ['CZX'], '白塔埠': ['LYG'],
                      '禄口国际': ['NKG'], '兴东': ['NTG'], '无锡': ['WUX'], '观音': ['XUZ'], '涟水': ['HIA'], '南洋': ['YNZ'],
                      '罗家': ['JDZ'], '井冈山': ['JGS'], '庐山': ['JIU'], '昌北': ['KHN'], '黄金': ['KOW'], '腾鳌': ['AOG'],
                      '朝阳': ['CHG'], '大长山岛': ['CNI'], '浪头': ['DDG'], '周水子': ['DLC'], '小岭子': ['JNZ'], '桃仙': ['SHE'],
                      '海兰泡': ['BAV'], '土城子': ['CIF'], '鄂尔多斯': ['DSN'], '白塔国际': ['HET'], '东山': ['HLD'], '乌兰浩特': ['HLH'],
                      '西郊': ['NZH'], '通辽': ['TGO'], '乌海': ['WUA'], '锡林浩特': ['XIL'], '河东': ['INC'], '格尔木': ['GOQ'],
                      '曹家堡': ['XNN'], '永安': ['DOY'], '曲阜': ['JNG'], '流亭国际': ['TAO'], '遥墙国际': ['TNA'],
                      '大水泊': ['WEH'], '莱山': ['YNT'], '临沂': ['LYI'], '王村': ['CIH'], '怀仁': ['DAT'], '武宿': ['TYN'],
                      '关公': ['YCU'], '五里铺': ['AKA'], '二十里铺': ['ENY'], '西沙': ['UYN'], '咸阳国际': ['XIY'],
                      '浦东国际': ['PVG'], '虹桥国际': ['SHA'], '双流国际': ['CTU'], '河市霸': ['DAX'], '广元': ['GNY'], '黄龙': ['JZH'],
                      '萱田': ['LZO'], '南郊': ['MIG'], '都尉坝': ['NAO'], '攀枝花': ['PZI'], '万县': ['WXN'], '青山': ['XIC'],
                      '菜坝': ['YBP'], '滨海国际': ['TSN'], '昌都马草': ['BPX'], '贡嘎': ['LXA'], '温宿': ['AKU'], '可可托托海': ['FYN'],
                      '哈密': ['HMI'], '阿勒泰': ['AAT'], '和田': ['HTN'], '且末': ['IQM'], '库车': ['KCA'], '喀什': ['KHG'],
                      '库尔勒': ['KRL'], '克拉玛依': ['KRY'], '塔城': ['TCG'], '那拉提': ['NLT'], '地窝堡国际': ['URC'], '伊宁': ['YIN'],
                      '交河': ['TLQ'], '保山': ['BSD'], '迪庆': ['DIG'], '大理': ['DLU'], '景洪': ['JHG'], '巫家坝国际': ['KMG'],
                      '丽江': ['LJG'], '临沧': ['LNJ'], '芒市': ['LUM'], '思茅': ['SYM'], '昭通': ['ZAT'], '文山普者黑': ['WNH'],
                      '萧山国际': ['HGH'], '普陀山': ['HSN'], '路桥': ['HYN'], '衢州': ['JUZ'], '栎社': ['NGB'], '永强': ['WNZ'],
                      '义乌': ['YIW'], '江北国际': ['CKG'], '五桥': ['WXN'], '香港国际': ['HKG'], '澳门国际': ['MFM'], '美兰': ['HAK'],
                      '凤凰': ['SYX'], '新郑': ['CGO'], '太平': ['HRB'], '天河': ['WUH'], '黄花': ['CSX'], '龙嘉': ['CGQ'],
                      '禄口': ['NKG'], '白塔': ['HET'], '流亭': ['TAO'], '遥墙': ['TNA'], '咸阳': ['XIY'],
                      '双流': ['CTU'], '滨海': ['TSN'], '地窝堡': ['URC'], '巫家坝': ['KMG'], '萧山': ['HGH'],
                      '江北': ['CKG'], '香港': ['HKG'], '澳门': ['MFM']}
...
time_map = {'下一': 7 - today.weekday(), '下二': 7 - today.weekday() + 1, '下日': 7 - today.weekday() + 6, '下四': 7 - today.weekday() + 3,
            ...
            '一': 0 - today.weekday(), '六': 5 - today.weekday(), '天': 6 - today.weekday(), '二': 1 - today.weekday(),
...
class Demo:
    def __init__(self, model_path='./ltp_data_v3.4.0/', result_path='./result', sent_path='./sentence', show=True):
        ...
        self.ticket_info = OrderedDict({
            ...
            'dCity': None,
            'nTickets': 1,
            'class': ['经济舱', '高端经济舱', '公务舱', '商务舱', '头等舱'],
            'company': ['中国国际航空公司', '国航', '东方航空公司', '东方航空', '东航', '南方航空公司', '南方航空', '南航', '海南航空公司', '幸福航空', '长龙航空', '成都航空',
               '海南航空', '海航', '上海航空公司', '上海航空', '上航', '山东航空公司', '山东航空', '山航', '深圳航空公司', '云南祥鹏航空', '西藏航空', '奥凯航空',
               '深圳航空', '深航', '厦门航空公司', '厦门航空', '厦航', '四川航空公司', '四川航空', '川航', '大新华航空', '大新华', '春秋航空', '吉祥航空',
               '鹰联航空', '华夏航空', '中国联合航空公司', '联合航空', '联航', '西部航空'],
            'flight_type': ['B737', '737', 'K320', 'M82', 'M90', 'B747', '747', 'B757', '757', 'B767', '767', 'B777', '777', 'B787', '787',
                   'M11', 'K300', 'K310', 'K330', 'K340', 'B738', 'K321', '738'],
            'flight_price': None,
            'discount': None,
            'price_flag': None,
    ...
    def _time_help(self):
        ...
        for word in ws:
            ...
            day = re.search(r"([零一二三四五六七八九十]{1,2})日", word)
            hour = re.search(r"([零一二三四五六七八九十]{1,2})时", word)
            money = re.search(r"(^[零两一二三四五六七八九千百十]{1,5}$)", word)
    ...
    def _time(self):
            ...
            if len(m) > 2:
                ...
                if self.ticket_info['sTime'] is None:
                    if int(m[0]) == now.month:
                        self.ticket_info['sTime'], self.ticket_info['dTime'] = [now.year, int(m[0]), now.day, 0], [now.year, int(m[0]), now.day, 23]
                    else:
                        self.ticket_info['sTime'], self.ticket_info['dTime'] = [now.year, int(m[0]), 1, 0], [now.year, int(m[0]), 3, 23]
                else:
                    self.ticket_info['sTime'][1], self.ticket_info['dTime'][1] = int(m[0]), int(m[0])
                    if int(m[0]) == now.month:
                        self.ticket_info['sTime'][2:] = [now.day, 0]
                        try:
                            a = self.ticket_info['sTime']
                            cur = datetime.datetime(a[0], a[1], a[2], a[3]) + datetime.timedelta(3)
                        except ValueError:
                            self.error = (1, '抱歉，您说的日期有误')
                            return None
                        self.ticket_info['dTime'] = [cur.year, cur.month, cur.day, cur.hour]
                    else:
                        self.ticket_info['sTime'][2:], self.ticket_info['dTime'][2:] = [1, 0], [3, 23]
            else:
                ...
                if self.ticket_info['sTime'] is None:
                    if int(m[0]) > int(m[1]):
                        ...
                        self.ticket_info['sTime'], self.ticket_info['dTime'] = [2017, int(m[0]), 1, 0], [2017, int(m[1]), 3, 23]
                    elif int(m[0]) < int(m[1]):
        ...
        if d:
            ...
            if len(d) > 2:
                if self.ticket_info['sTime'] is None:
                    self.ticket_info['sTime'], self.ticket_info['dTime'] = [now.year, now.month, int(d[-1][0]), 0], [now.year, now.month, int(d[-1][0]), 23]
                else:
                    self.ticket_info['sTime'][2], self.ticket_info['dTime'][2] = int(d[-1][0]), int(d[-1][0])
                    try:
                        a, b = self.ticket_info['sTime'], self.ticket_info['dTime']
                        cur1, cur2 = datetime.datetime(a[0], a[1], a[2], a[3]), datetime.datetime(b[0], b[1], b[2], b[3])
                    except ValueError:
                        self.error = (1, '抱歉，您说的日期有问题')
                        return None
                    if (cur1 - now).days < -1 or (cur2 - cur1).days < 0:
                        self.error = (1, '抱歉，您说的日期有问题')
                        return None
            elif len(d) == 1:
                ...
                if d[0][1] == '后':
                    if self.ticket_info['sTime'] is None:
                        ...
                        cur = datetime.datetime(now.year, now.month, int(d[0][0])) + datetime.timedelta(3)
                        self.ticket_info['dTime'] = [cur.year, cur.month, cur.day, 23]
                    else:
                    ...
                    if self.ticket_info['sTime'] is None:
                        ...
                        if (cur - now).days < 0:
                            self.error = (1, '抱歉，您说的日期有问题')
                            return None
                        cur = max(cur - datetime.timedelta(3), now)
                    ...
                    if self.ticket_info['sTime'] is None:
                        self.ticket_info['sTime'], self.ticket_info['dTime'] = [now.year, now.month, int(d[0][0]), 0], \
                                                                               [now.year, now.month, int(d[0][0]), 23]
                    else:
                        self.ticket_info['sTime'][2:], self.ticket_info['dTime'][2:] = [int(d[0][0]), 0], [int(d[0][0]), 23]
                        try:
                            a, b = self.ticket_info['sTime'], self.ticket_info['dTime']
                            cur1, cur2 = datetime.datetime(a[0], a[1], a[2], a[3]), datetime.datetime(b[0], b[1], b[2], b[3])
                        except ValueError:
        ...
        if w:
            flag = True
            if len(w) > 2:
                tt = time_map[w[-1][0]+w[-1][2]]
                if tt < 0:
                    tt += 7
                cur = now + datetime.timedelta()
                if self.ticket_info['sTime'] is None:
                    self.ticket_info['sTime'] = [cur.year, cur.month, cur.day, 0]
                    self.ticket_info['dTime'] = [cur.year, cur.month, cur.day, 23]
                else:
                ...
                tt = time_map[w[0][0]+w[0][2]]
                if tt < 0:
                    tt += 7
                cur = now + datetime.timedelta(tt)
                if w[0][3] == '后':
                    if self.ticket_info['sTime'] is None:
                        self.ticket_info['sTime'] = [cur.year, cur.month, cur.day, 0]
                        cur += datetime.timedelta(3)
                        self.ticket_info['dTime'] = [cur.year, cur.month, cur.day, 23]
                    else:
                        self.ticket_info['sTime'] = [cur.year, cur.month, cur.day, 0]
                        temp = self.ticket_info['dTime']
                        if cur > datetime.datetime(temp[0], temp[1], temp[2], temp[3]):
                            self.error = (1, "对不起，您说的时间有问题")
                            return None
                elif w[0][3] == '前':
                ...
                tt1, tt2 = time_map[w[0][0]+w[0][2]], time_map[w[1][0]+w[1][2]]
                if tt1 < 0:
                    tt1 += 7
                if tt2 < 0:
                    tt2 += 7
                ...
                cur1 = now + datetime.timedelta(tt1)
                cur2 = now + datetime.timedelta(tt2)
                if self.ticket_info['sTime'] is None:
        ...
        if d1:
            ...
            if len(d1) > 2:
                cur = now + datetime.timedelta(dict_temp[d1[-1][0]])
                if self.ticket_info['sTime'] is None:
                    self.ticket_info['sTime'] = [cur.year, cur.month, cur.day, 0]
                    self.ticket_info['dTime'] = [cur.year, cur.month, cur.day, 23]
                else:
        ...
        if ma:
            flag = True
            dict_temp3 = {'早上': (0, 9), '中午': (10, 14), '上午': (6, 12), '下午': (12, 19), '晚上': (17, 23)}
            after = {'早上': 5, '中午': 12, '上午': 10, '下午': 19, '晚上': 19}
            before = {'早上': 6, '中午': 12, '上午': 8, '下午': 14, '晚上': 18}
    ...
    def _places(self):
        ...
        if place_1:
            ...
            if place_1 in set_province:
                self.error = (1, "不好意思，请告诉我具体的城市。")
                return None
            if place_1 not in dict_plane_to_code.keys() and place_1 not in dict_city_to_code.keys():
                self.error = (1, "抱歉，该城市没有机场")
                return None
        if place_2:
            ...
            if place_2 in set_province:
                self.error = (1, "不好意思，请告诉我具体的城市。")
                return None
            if place_2 not in dict_plane_to_code.keys() and place_2 not in dict_city_to_code.keys():
                self.error = (1, "抱歉，该城市没有机场")
                return None
        # print(place_1, "|", place_2, "|", place_3)
    ...
    def _class(self):
        ...
        temp = set(self.ticket_info['class'])
        if c2 != set():
            if temp.intersection(c2):
                temp = temp.intersection(c2)
            else:
                temp = c2

        self.ticket_info['class'] = list(temp.difference(c1))
    ...
    def _flight_type(self):
        ...
        temp = set(self.ticket_info['flight_type'])
        if temp2 != set():
            if temp.intersection(temp2):
                temp = temp.intersection(temp2)
            else:
                temp = temp2

        self.ticket_info['flight_type'] = list(temp.difference(temp1))
    ...
    def _company(self):
        ...
        for kk in [set(['中国国际航空公司', '国航']),set(['东方航空公司', '东方航空', '东航']),set(['南方航空公司', '南方航空', '南航']),set(['海南航空公司', '海南航空', '海航']),
                   ...
                   set(['中国联合航空公司', '联合航空', '联航']),set(['四川航空公司', '四川航空', '川航']),set(['大新华航空', '大新华'])]:
            if kk.intersection(c1):
                c1 = c1.union(kk)
            elif kk.intersection(c2):
                c2 = c2.union(kk)
        # print(c1, "|", c2)
        temp = set(self.ticket_info['company'])
        if c2 != set():
            if temp.intersection(c2):
                temp = temp.intersection(c2)
            else:
        ...
        self.ticket_info['company'] = list(temp.difference(c1))
    ...
    def _price(self):
        ...
        m1 = re.findall(r"[低少]于(\d{3,})", sent)
        m2 = re.findall(r"(\d{3,})(块钱|块)*[之以]下", sent)
        b1 = re.findall(r"(\d{3,})(块钱|块)*[到至](\d{3,})(块钱|块)*", sent)
    ...
    def _discount(self):
        ...
        m1 = re.findall(r"([一二三四五六七八九]{1,2}|[123456789]{1,2})折", sent)
    ...
    def _flag(self):
        ...
        if price is not None or ti is not None:
            return price, ti
        else:
            return None

    def _flights(self, start, end, ti):
        md = hashlib.md5()
        ...
        concat = 'createTime=%skey=%sparams={"dpt":"%s","arr":"%s","date":"%d-%02d-%02d","ex_track":"tehui"}tag=%stoken=%s' % \
                 (createTime, key, start, end, ti.year, ti.month, ti.day, tag, token)
        ...
        data = OrderedDict({
            ...
            'params': '{"dpt":"%s","arr":"%s","date":"%d-%02d-%02d","ex_track":"tehui"}' % (start, end,  ti.year, ti.month, ti.day),
        })
    ...
    def _response(self):
        ...
        if self.total_flight == []:
            ...
            t1, t2 = self.ticket_info['sTime'], self.ticket_info['dTime']
            tt2 = datetime.datetime(t2[0], t2[1], t2[2], t2[3])
            for start in set1:
                for end in set2:
                    tt1 = datetime.datetime(t1[0], t1[1], t1[2], 0)
                    # print(start, "|", end)
                    while tt1 < tt2:
                        temp = self._flights(start, end, tt1)
                        tt1 += datetime.timedelta(1)
                        if temp and temp['result']:
                            self.total_flight.extend(temp['result']['flightInfos'])
                            # print(temp['result']['total'])
            ...
            if self.first_time == 1:
                ...
                for flight in self.total_flight:
                    ...
                    if self.ticket_info['discount']:
                        ...
                        if dis > int(self.ticket_info['discount']):
                            continue
        ...
        self.cur_flight = sorted(self.cur_flight,
                                 key=lambda item: datetime.datetime(2018, 1, 12, int(item['dptTime'][:2]), int(item['dptTime'][-2:])))
        if self.cur_flight == []:
            if self.first_time == 1:
                self._default()
    ...
    def booking(self, sent):
        ...
        if self._is_relate(sent):
            ...
            if self._start() or self._book():
                ...
                self.answer.append(sent_error2[rand % len(sent_error2)])
                self.error_times += 1
