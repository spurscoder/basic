...
class Demo:
    ...
    def _discount(self):
        ...
        m1 = re.findall(r"([一二三四五六七八九123456789]{1,2})折[之以]下", sent)
        m2 = re.findall(r"低于([一二三四五六七八九123456789]{1,2})折", sent)
        m3 = re.findall(r"([一二三四五六七八九123456789]{1,2})折", sent)
        ...
        if m1:
            ...
            if len_word > 2:
                ...
                if word[0] in nums_map.keys() and word[1] in nums_map.keys():
                    ...
                    self.error = (11, '抱歉，你说的折扣有问题。')
                    return None
            elif len_word == 1:
                if word[0] in nums_map.keys():
                    result = str(nums_map[word[0]]) + '0'
                else:
                    self.error = (11, '你说的折扣有点问题')
                    return None
    ...
    def _response(self):
        ...
        if self.total_flight == []:
            ...
            if set1 == []:
                self.answer = ['抱歉，我认为', self.ticket_info['sCity'], '没有机场']
                return
            if set2 == []:
                self.answer = ['对不起，我认为', self.ticket_info['dCity'], '没有机场']
                return
