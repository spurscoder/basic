...
sent_topic = {
    ...
    'search': ['现在,为您查询到以下结果', '查询结果如下', '那现在，为您查到这些机票', '有以下机票供您选择',
               '已经为您查到这些机票信息', '现在，已经有了这些信息', '有如下机票信息', '您有以下几种票可选']}
...
class Demo:
    ...
    def _flights(self):
        ...
        params = '{"dpt":"SHA","arr":"PEK","date":"2017-12-10","ex_track":"tehui"}'
        tag = 'flight.national.supply.sl.searchflight'
        token = 'e2d43dd7f897f3e26c6c72b303abdd32'
        concat = 'createTime=' + str(createTime) + 'key=' + key + 'params=' + params + 'tag=' + tag + 'token=' + token
